...
module.exports = client => {
            ...
            if(prefixRegex.test(message.content)) {
                ...
                if(cmd && cmd.length > 0){
                    ...
                    if(cmd == "close"){
                            ...
                            return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setColor("RED")
                                            .setTitle("❌ 'Dieser Kanal wurde schon gelöscht/ der User hat den Server verlassen'!")
                                        ]
                                }).catch(console.error);
                                ...
                                return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                            .setColor("RED")
                                            .setTitle("❌ Der User hat den Server verlassen")
                                        ]
                                }).catch(console.error)
                            })
                            if(!author){
                            ...
                            await message.author.send({
                                ...
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("GREEN")
                                        .setTitle("✅ Ticket wurde von einem Support geschlossen")
                                    ]
                            }).catch(console.error)
                            await message.reply({
                                files: attachment,
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setColor("GREEN")
                                        .setTitle("✅ Ticket wurde von einem Support geschlossen")
                                        .setDescription(`Der Kanal kann jetzt gelöscht werden!`)
                                    ]
                            }).catch(console.error)
                        ...
                        message.reply({embeds: [
                            new Discord.MessageEmbed().setColor("BLURPLE").setTitle(`:white_check_mark: **API wird gepingt...**`)
                        ]}).then((msg)=>{
                        ...
                        if(data.category == message.channel.parentId){
                            ...
                            return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                            .setColor("RED")
                                            .setTitle("❌ Dieser Kanal wurde geschlossen/ der User hat den Server verlassen!")                            ]
                                }).catch(console.error);
                            let author = message.guild.members.cache.get(authorId);
                            if(!author)
                            author = await message.guild.members.fetch(authorId).catch(e=>{
                                ...
                                return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setColor("RED")
                                            .setTitle("❌ Der User hat den Server verlassen.")
                                            .setDescription(`Schließe das Ticekt mit: \`${config.prefix}close\``)
                                        ]
                                }).catch(console.error)
                            })
                            if(!author){
                            ...
                            .setDescription(`${message.content}`.substr(config.prefix.length + 5, 2048))
                            .addField(`Höchste Rolle:`, `${message.member.roles.highest.name} | \`${message.member.roles.highest.id}\``);
                            ...
                            author.send({
                                ...
                                return message.reply({
                                    embeds: [
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("RED")
                                        .setTitle("❌ Nachricht konnte nicht in den Kanal gesendet werden.")
    ...
    client.on("ready", () => {
        client.user.setActivity({
            name: `${config.botstatus} | ${config.prefix}help | ` , type: config.statustyp, url: "https://twitch.tv/#"
        })
    })
    // DMS
    client.on("messageCreate", async (message) => {
        ...
        if(!message.guild || message.channel.type == "DM") {
            ...
            if(!client.modmailDb.has(dmauthor.id)){
                ...
                if(guildsin.length == 0){
                    return message.reply({
                        embeds: [
                            new Discord.MessageEmbed()
                                ...
                                .setColor("RED")
                                .setTitle("❌ Du hast keine gemeinsamen Server mit mir!")                        ]
                    }).catch(console.error)
                }
                    ...
                    let selectedid = config.serverid;
                        ...
                        message.reply({
                            embeds: [
                                new Discord.MessageEmbed()
                                    ...
                                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                                    .setColor("RED")
                                    .setTitle("❌ Keine Server-ID wurde angegeben. Bitte kontaktiere einen Admin")                            ]
                        }).catch(console.error)
                    ...
                    return message.reply({
                        embeds: [
                            new Discord.MessageEmbed()
                                ...
                                .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                                .setColor("RED")
                                .setTitle("❌ Kein Support-Server wurde konfiguriert!")
                            ]
                    }).catch(console.error)
                }
                    ...
                    return message.reply({
                        embeds: [
                            new Discord.MessageEmbed()
                                ...
                                .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                                .setColor("RED")
                                .setTitle("❌ Kein Support-Kanal wurde gefunden!")
                            ],
                            components: [
                ...
                channel.send({
                    ...
                    return message.reply({
                        embeds: [
                            ...
                            .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                            .setColor("RED")
                            .setTitle("❌ Es konnte keine Nachricht in den Kanal gesendet werden")
                            .setDescription(`\`\`\`${error.message ? String(error.message).substr(0, 2000) : String(e).substr(0, 2000)}\`\`\``)
                           ]
                    }).catch(console.error)
                })
        ...
        if(interaction.isButton() && interaction.customId == "close_modmail_ticket" && !interaction.guildId){
            ...
            if(!client.modmailDb.has(dmauthor.id))
                return interaction.reply({
                    content: "❌ **Dein Ticket wurde schon geschlossen!**",
                    ephemeral: true
                })
                ...
                return interaction.reply({
                    embeds: [
                        new Discord.MessageEmbed()
                            ...
                            .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                            .setColor("RED")
                            .setTitle("❌ Kein Support-Kanal wurde konfiguriert!")
                        ],
                        components: [
                            new Discord.MessageActionRow().addComponents(
                                new Discord.MessageButton().setStyle("SECONDARY").setLabel("FORCE CLOSE IT").setCustomId("force_modmail_close").setEmoji("❎")
            ...
            await dmauthor.send({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                        .setColor("GREEN")
                        .setTitle("✅ Du hast das Ticket geschlossen")
                    ]
            }).catch(console.error)
            await channel.send({
                files: attachment,
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                        .setColor("GREEN")
                        .setTitle("✅ Nutzer hat das Ticket geschlossen")
                        .setDescription(`Dieser Kanal kann jetzt gelöscht werden!`)
                    ]
            }).catch(console.error)
            ...
            return interaction.reply({
                    embeds: [
                        new Discord.MessageEmbed()
                            ...
                            .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                            .setColor("RED")
                            .setTitle("❌ Dieses Ticket wurde geschlossen / Der User hat den Server verlassen!")
                        ]
                }).catch(console.error);
                ...
                return interaction.reply({
                    embeds: [
                        new Discord.MessageEmbed()
                            ...
                            .setColor("RED")
                            .setTitle("❌ Der User hat den Server verlassen")
                            .setDescription(`Schließe das Ticket mit: \`${config.prefix}close\``)
                        ]
                }).catch(console.error)
            })
            interaction.reply({
            ...
            await author.send({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                        .setColor("GREEN")
                        .setTitle("✅ Dein Ticket wurde von einem Supporter geschlossen")
                    ]
            }).catch(console.error)
            await interaction.message.reply({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                        .setColor("GREEN")
                        .setTitle("✅ Ticket wurde von einem Supporter geschlossen")
                        .setDescription(`Kanal kann gelöscht werden!`)
                    ]
            }).catch(console.error)
    ...
    function startSupportProcess(guild, message, dmauthor){
        client.modmailDb.ensure(config.serverid, {
            enabled: true,
            category: config.kategorie,
            message: config.nachricht
        })
        ...
        guild.channels.create(`${dmauthor.username}-${dmauthor.tag}`.substr(0, 32) , {
            ...
            if(category) {
                channel.setParent(config.kategorie);
            }
            ...
            message.reply({
                embeds: [
                    ...
                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                    .setColor("BLURPLE")
                    .setTitle("✅ Dein Support Ticket wurde erstellt!")
                   ...
                   components: [ new Discord.MessageActionRow().addComponents(new Discord.MessageButton()
                    .setStyle("DANGER").setEmoji("💥").setLabel("Ticket schließen").setCustomId("close_modmail_ticket"))]
            }).catch(console.error)
            channel.send({
                embeds: [
                    new Discord.MessageEmbed()
            ...
            return message.reply({
                embeds: [
                    ...
                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                    .setColor("RED")
                    .setTitle("❌ Support Ticket konnte nicht erstellt werden!")
                    .setDescription(`\`\`\`${error.message ? String(error.message).substr(0, 2000) : String(e).substr(0, 2000)}\`\`\``)
                   ]
            }).catch(console.error)
        })
      ...
      try{
        ...
        await msgs.forEach(async msg => {
            ...
            if(msg.type == "DEFAULT"){
              ...
              `<div class="messages">` + 
              `<span class="ath-name" title="${msg.author.username}" style="color: #ff2323;">${msg.author.tag}</span>`;
